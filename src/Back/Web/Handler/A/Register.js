...
export default class Fl64_Auth_Otp_Back_Web_Handler_A_Register {
     ...
     * @param {Fl64_Auth_Otp_Back_Email_Register} servEmailRegister
    ...
    constructor({
                    ...
                    Fl64_Auth_Otp_Back_Email_Register$: servEmailRegister,
        ...
        const RESULT_EMAIL = servEmailRegister.getResultCodes();
        ...
        this.run = async function (req, res) {
            ...
            async function doGet(req, res) {
                ...
                const {content} = await tmplRender.perform({
                    pkg: DEF.NAME, type: 'web', name: 'register.html', view: {xsrfToken},
                });
                        ...
                        await trxWrapper.execute(null, async (trx) => {
                            ...
                            if (!record) {
                                ...
                                if (canRegister) {
                                    ...
                                    debugger
                                    const {resultCode} = await servEmailRegister.perform({
                                        trx,
                                        userId: id,
                                        localeUser,
                                        localeApp
