/**
 * Repository for managing user emails used in OTP authentication.
 * @implements TeqFw_Db_Back_Api_RDb_Repository
 */
export default class Fl64_Auth_Otp_Back_Store_RDb_Repo_Email {
    /**
     * @param {TeqFw_Db_Back_App_Crud} crud - CRUD engine for database operations.
     * @param {Fl64_Auth_Otp_Back_Store_RDb_Schema_Email} schema - Persistent DTO schema for user emails.
     */
    constructor(
        {
            TeqFw_Db_Back_App_Crud$: crud,
            Fl64_Auth_Otp_Back_Store_RDb_Schema_Email$: schema,
        }
    ) {
        /**
         * @param {Fl64_Auth_Otp_Back_Store_RDb_Schema_Email.Dto} [dto]
         ...
         * @param {Fl64_Auth_Otp_Back_Store_RDb_Schema_Email.Dto} [params.dto]
        ...
        /**
         * @returns {Fl64_Auth_Otp_Back_Store_RDb_Schema_Email}
         */
         ...
         * @returns {Promise<{records: Array<Fl64_Auth_Otp_Back_Store_RDb_Schema_Email.Dto>}>}
         */
         ...
         * @returns {Promise<{record: Fl64_Auth_Otp_Back_Store_RDb_Schema_Email.Dto|null}>}
         */
